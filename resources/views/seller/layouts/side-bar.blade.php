        ...
        <div class="sidebar_menu_block">
            <div class="mobile_menu_header">
                <div class="logo_wrap">
                    <div class="logo">
                        <a href="#0">
                            <img src="{{asset('assets/image/dashborad_logo.png')}}" alt="logo" class="logo_img">
                        </a>
                    </div>
                ...
                <ul>
                    <li>
                        <a href="index.html" data-bs-toggle="tooltip" data-bs-placement="right" title="Dashboard">
                            <div class="menu_icon">
                                <img src="{{asset('assets/image/sidebar/dashboard.png')}}" alt="icon">
                            </div>
                    ...
                    <li>
                        <div class="accordion_menu_wrap">
                            <a class="active" href="#0" data-bs-toggle="tooltip" data-bs-placement="right" title="Termine">
                                <div class="menu_icon">
                                    <img src="{{asset('assets/image/sidebar/product.png')}}" alt="icon">
                                </div>
                    ...
                    <li>
                        <a href="Labor.html" data-bs-toggle="tooltip" data-bs-placement="right" title="Labor">
                            <div class="menu_icon">
                                <img src="{{asset('assets/image/sidebar/order.png')}}" alt="icon">
                            </div>
                    ...
                    <li>
                        <a href="index.html" data-bs-toggle="tooltip" data-bs-placement="right" title="Dashboard">
                            <div class="menu_icon">
                                <img src="{{asset('assets/image/sidebar/marketing.png')}}" alt="icon">
                            </div>
                    ...
                    <li>
                        <a href="termine.html" data-bs-toggle="tooltip" data-bs-placement="right" title="Termine">
                            <div class="menu_icon">
                                <img src="{{asset('assets/image/sidebar/payment.png')}}" alt="icon">
                            </div>
                    ...
                    <li>
                        <a href="Labor.html" data-bs-toggle="tooltip" data-bs-placement="right" title="Labor">
                            <div class="menu_icon">
                                <img src="{{asset('assets/image/sidebar/wallet.png')}}" alt="icon">
                            </div>
                    ...
                    <li>
                        <a href="index.html" data-bs-toggle="tooltip" data-bs-placement="right" title="Dashboard">
                            <div class="menu_icon">
                                <img src="{{asset('assets/image/sidebar/support.png')}}" alt="icon">
                            </div>
                    ...
                    <li>
                        <a href="termine.html" data-bs-toggle="tooltip" data-bs-placement="right" title="Termine">
                            <div class="menu_icon">
                                <img src="{{asset('assets/image/sidebar/referralsystem.png')}}" alt="icon">
                            </div>
                    ...
                    <li>
                        <a href="Labor.html" data-bs-toggle="tooltip" data-bs-placement="right" title="Labor">
                            <div class="menu_icon">
                                <img src="{{asset('assets/image/sidebar/FAQ.png')}}" alt="icon">
                            </div>
                    ...
                    <li>
                        <a href="Labor.html" data-bs-toggle="tooltip" data-bs-placement="right" title="Labor">
                            <div class="menu_icon">
                                <img src="{{asset('assets/image/sidebar/Profile.png')}}" alt="icon">
                            </div>
